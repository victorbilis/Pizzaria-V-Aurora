...
public class ini extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_card = (Button) findViewById(R.id.button5);
        ped = (Button) findViewById(R.id.button3);

        btn_card.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(ini.this,card.class);
                startActivity(i);
            }
        });
        ...
        ped.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(ini.this,ped.class);
                startActivity(i);
            }
        });
